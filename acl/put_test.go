...
func TestPutACL(t *testing.T) {
	acl := ACL{
		12345: map[uint32]types.Card{
			65536: types.Card{CardNumber: 65536, From: date("2020-03-04"), To: date("2020-12-31"), Doors: map[uint8]types.Permission{1: true, 2: false, 3: true, 4: false}},
			...
			65538: types.Card{CardNumber: 65538, From: date("2020-02-03"), To: date("2020-12-31"), Doors: map[uint8]types.Permission{1: false, 2: false, 3: false, 4: false}},
		},
	}
	...
	expected := []types.Card{
		...
		types.Card{CardNumber: 65538, From: date("2020-02-03"), To: date("2020-12-31"), Doors: map[uint8]types.Permission{1: false, 2: false, 3: false, 4: false}},
		types.Card{CardNumber: 65536, From: date("2020-03-04"), To: date("2020-12-31"), Doors: map[uint8]types.Permission{1: true, 2: false, 3: true, 4: false}},
	}
...
func TestPutACLWithMultipleDevices(t *testing.T) {
	acl := ACL{
		12345: map[uint32]types.Card{
			...
			65537: types.Card{CardNumber: 65537, From: date("2020-01-01"), To: date("2020-12-31"), Doors: map[uint8]types.Permission{1: true, 2: false, 3: false, 4: false}},
			65538: types.Card{CardNumber: 65538, From: date("2020-01-01"), To: date("2020-12-31"), Doors: map[uint8]types.Permission{1: false, 2: false, 3: false, 4: true}},
		},

		54321: map[uint32]types.Card{
			65536: types.Card{CardNumber: 65536, From: date("2020-01-02"), To: date("2020-12-31"), Doors: map[uint8]types.Permission{1: false, 2: false, 3: true, 4: false}},
			65537: types.Card{CardNumber: 65537, From: date("2020-03-04"), To: date("2020-11-30"), Doors: map[uint8]types.Permission{1: false, 2: true, 3: false, 4: false}},
			65538: types.Card{CardNumber: 65538, From: date("2020-05-06"), To: date("2020-10-29"), Doors: map[uint8]types.Permission{1: true, 2: false, 3: false, 4: false}},
		},
	}

	expected := map[uint32][]types.Card{
		12345: []types.Card{
			types.Card{CardNumber: 65537, From: date("2020-01-01"), To: date("2020-12-31"), Doors: map[uint8]types.Permission{1: true, 2: false, 3: false, 4: false}},
			types.Card{CardNumber: 65538, From: date("2020-01-01"), To: date("2020-12-31"), Doors: map[uint8]types.Permission{1: false, 2: false, 3: false, 4: true}},
			types.Card{CardNumber: 65536, From: date("2020-01-01"), To: date("2020-12-31"), Doors: map[uint8]types.Permission{1: true, 2: false, 3: true, 4: false}},
		},

		54321: []types.Card{
			types.Card{CardNumber: 65536, From: date("2020-01-02"), To: date("2020-12-31"), Doors: map[uint8]types.Permission{1: false, 2: false, 3: true, 4: false}},
			types.Card{CardNumber: 65537, From: date("2020-03-04"), To: date("2020-11-30"), Doors: map[uint8]types.Permission{1: false, 2: true, 3: false, 4: false}},
			types.Card{CardNumber: 65538, From: date("2020-05-06"), To: date("2020-10-29"), Doors: map[uint8]types.Permission{1: true, 2: false, 3: false, 4: false}},
		},
	}
	...
	cards := map[uint32][]types.Card{
		12345: []types.Card{
			types.Card{CardNumber: 65537, From: date("2020-01-01"), To: date("2020-12-31"), Doors: map[uint8]types.Permission{1: true, 2: false, 3: false, 4: false}},
			types.Card{CardNumber: 65538, From: date("2020-01-01"), To: date("2020-11-30"), Doors: map[uint8]types.Permission{1: true, 2: true, 3: true, 4: true}},
			types.Card{CardNumber: 65539, From: date("2020-01-01"), To: date("2020-10-31"), Doors: map[uint8]types.Permission{1: true, 2: true, 3: true, 4: true}},
		},
...
func TestPutACLWithNoCurrentPermissions(t *testing.T) {
	acl := ACL{
		12345: map[uint32]types.Card{
			65537: types.Card{CardNumber: 65537, From: date("2020-03-04"), To: date("2020-10-31"), Doors: map[uint8]types.Permission{1: false, 2: false, 3: true, 4: false}},
		},
	}

	expected := []types.Card{
		types.Card{CardNumber: 65537, From: date("2020-03-04"), To: date("2020-10-31"), Doors: map[uint8]types.Permission{1: false, 2: false, 3: true, 4: false}},
	}
